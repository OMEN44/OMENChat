    ...
    return function i(s, a, l) {
        ...
        7: [function(t, e, n) {
            ...
            var r = t("json3")
                , o = t("./utils/iframe");
            function i(t) {
                (this._transport = t).on("message", this._transportMessage.bind(this)),
                ...
                t.forEach(function(t) {
                    ...
                    l.bootstrap_iframe = function() {
                        ...
                        r.attachEvent("message", function(e) {
                            if (e.source === parent && (void 0 === c && (c = e.origin),
                            e.origin === c)) {
                                var n;
                                try {
                                    n = h.parse(e.data)
                                ...
                                if (n.windowId === p.currentWindowId)
                                    switch (n.type) {
                                        case "s":
                                            ...
                                            if (v(r, o, i, s),
                                            r !== l.version)
                                                throw new Error('Incompatible SockJS! Main site uses: "' + r + '", the iframe: "' + l.version + '".');
                                            if (!f.isOriginEqual(i, m.href) || !f.isOriginEqual(s, m.href))
                                                throw new Error("Can't connect to different domain from within an iframe. (" + m.href + ", " + i + ", " + s + ")");
                                            a = new d(new u[o](i,s));
                                            break;
                                        case "m":
                                            a._send(n.data);
            ...
            function l(t) {
                ...
                o.call(this),
                    ...
                    this.ir.once("finish", function(t, e) {
                        n.ir = null,
                            n.emit("message", i.stringify([t, e]))
                    })
            }
            r(l, o),
        ...
        14: [function(_, E, t) {
            (function(i) {
                    "use strict";
                    _("./shims");
                    var r, l = _("url-parse"), t = _("inherits"), s = _("json3"), c = _("./utils/random"), e = _("./utils/escape"), u = _("./utils/url"), a = _("./utils/event"), n = _("./utils/transport"), o = _("./utils/object"), f = _("./utils/browser"), h = _("./utils/log"), d = _("./event/event"), p = _("./event/eventtarget"), m = _("./location"), v = _("./event/close"), b = _("./event/trans-message"), y = _("./info-receiver"), g = function() {};
                    function w(t, e, n) {
                    ...
                    t(w, p),
                        ...
                        w.prototype._transportMessage = function(t) {
                            ...
                            switch (r) {
                                ...
                                case "h":
                                    return this.dispatchEvent(new d("heartbeat")),
                        ...
                        w.prototype._transportClose = function(t, e) {
                            ...
                            this._transport && (this._transport.removeAllListeners(),
                                ...
                                this.transport = null),
                                x(t) || 2e3 === t || this.readyState !== w.CONNECTING ? this._close(t, e) : this._connect()
                        }
                        ,
                        w.prototype._open = function() {
                            g("_open", this._transport && this._transport.transportName, this.readyState),
                                this.readyState === w.CONNECTING ? (this._transportTimeoutId && (clearTimeout(this._transportTimeoutId),
                                    ...
                                    g("connected", this.transport)) : this._close(1006, "Server lost session")
                        }
                        ,
        ...
        15: [function(t, e, n) {
            ...
            var o, u = Array.prototype, i = Object.prototype, r = Function.prototype, s = String.prototype, c = u.slice, f = i.toString, h = Object.defineProperty && function() {
                try {
            ...
            function d(t, e, n) {
                for (var r in e)
                    i.hasOwnProperty.call(e, r) && o(t, r, e[r], n)
            }
            function p(t) {
                if (null == t)
            ...
            d(r, {
                bind: function(e) {
                    ...
                    for (var r = c.call(arguments, 1), t = Math.max(0, n.length - r.length), o = [], i = 0; i < t; i++)
                        o.push("$" + i);
                    ...
                    return n.prototype && (m.prototype = n.prototype,
                        s.prototype = new m,
                        m.prototype = null),
                        s
                }
            ...
            d(u, {
                forEach: function(t, e) {
                    ...
                    if (!a(t))
                        throw new TypeError;
                    for (; ++i < s; )
                        i in r && t.call(o, r[i], i, n)
                }
            }, (v = u.forEach,
                y = b = !0,
            v && (v.call("foo", function(t, e, n) {
                "object" != typeof n && (b = !1)
            }),
                v.call([1], function() {
            ...
            2 !== "ab".split(/(?:ab)*/).length || 4 !== ".".split(/(.?)(.?)/).length || "t" === "tesst".split(/(s)*/)[1] || 4 !== "test".split(/(?:)/, -1).length || "".split(/.?/).length || 1 < ".".split(/()()/).length ? (_ = void 0 === /()??/.exec("")[1],
                    s.split = function(t, e) {
                        ...
                        if (void 0 === t && 0 === e)
                            return [];
                        if ("[object RegExp]" !== f.call(t))
                            return E.call(this, t, e);
                        var r, o, i, s, a = [], l = (t.ignoreCase ? "i" : "") + (t.multiline ? "m" : "") + (t.extended ? "x" : "") + (t.sticky ? "y" : ""), c = 0;
                        for (t = new RegExp(t.source,l + "g"),
                                 n += "",
                             _ || (r = new RegExp("^" + t.source + "$(?!\\s)",l)),
                                 e = void 0 === e ? -1 >>> 0 : function(t) {
                                     return t >>> 0
                                 }(e); (o = t.exec(n)) && !(c < (i = o.index + o[0].length) && (a.push(n.slice(c, o.index)),
                        !_ && 1 < o.length && o[0].replace(r, function() {
                            for (var t = 1; t < arguments.length - 2; t++)
                                void 0 === arguments[t] && (o[t] = void 0)
                        }),
                        1 < o.length && o.index < n.length && u.push.apply(a, o.slice(1)),
                            s = o[0].length,
                            c = i,
                        a.length >= e)); )
                            t.lastIndex === o.index && t.lastIndex++;
                        return c === n.length ? !s && t.test("") || a.push("") : a.push(n.slice(c)),
            ...
            (function(t) {
                    ...
                    e(u, i),
                        u.prototype._start = function(t, e, n, r) {
                            ...
                            if (r && r.noCredentials || !u.supportsCORS || (c("withCredentials"),
                    ...
                    !u.enabled && n in t && (c("overriding xmlhttprequest"),
        ...
        22: [function(t, e, n) {
            ...
            r(h, i),
                ...
                h.prototype._message = function(e) {
                    if (f("message", e.data),
                        a.isOriginEqual(e.origin, this.origin)) {
                        var n;
                        try {
                            n = o.parse(e.data)
                        } catch (t) {
                        ...
                        if (n.windowId === this.windowId)
                            switch (n.type) {
                                ...
                                case "c":
                                    ...
                                    this.emit("close", t[0], t[1]),
                                        this.close()
                            }
                        else
                            f("mismatched window id", n.windowId, this.windowId)
                    } else
                        f("not same origin", e.origin, this.origin)
                }
                ,
                        ...
                        return e(t, i),
                            t.enabled = function(t, e) {
                                if (!o.document)
                                    return !1;
                                var n = s.extend({}, e);
                                return n.sameOrigin = !0,
                                r.enabled(n) && i.enabled()
                            }
                            ,
                    ...
                    r.on("message", function(t) {
                        ...
                        r.once("close", function(t, e) {
                            i("close", t, e, n.pollIsClosing),
                                n.poll = r = null,
                            n.pollIsClosing || ("network" === e ? n._scheduleReceiver() : (n.emit("close", t || 1006, e),
                        ...
                        u.prototype._createScript = function(t) {
                            ...
                            if (r.id = "a" + s.string(8),
                                ...
                                r.onreadystatechange = function() {
                                    if (c("onreadystatechange", r.readyState),
                            ...
                            void 0 === r.async && i.document.attachEvent)
                                if (a.isOpera())
                                    (e = this.script2 = i.document.createElement("script")).text = "try{var a = document.getElementById('" + r.id + "'); if(a)a.onerror();}catch(x){};",
                                        r.async = e.async = !1;
                                else {
                                    try {
                                        r.htmlFor = r.id,
        ...
        33: [function(t, e, n) {
            (function(s) {
                    ...
                    e.exports = function(t, e, n) {
                        f(t, e),
                        a || (f("createForm"),
                            (a = s.document.createElement("form")).style.display = "none",
        ...
        43: [function(t, e, n) {
            (function(n) {
                    ...
                    n.crypto && n.crypto.getRandomValues ? e.exports.randomBytes = function(t) {
                            ...
                            return n.crypto.getRandomValues(e),
                                e
                        }
            ...
            (function(f) {
                    ...
                    p.exports = {
                        ...
                        createHtmlfile: function(t, e) {
                            ...
                            c.open(),
                                c.write('<html><script>document.domain="' + f.document.domain + '";<\/script></html>'),
                                c.close(),
                                c.parentWindow[p.exports.WPrefix] = f[p.exports.WPrefix];
                            var u = c.createElement("div");
                            return c.body.appendChild(u),
                    ...
                    f.document && (p.exports.iframeEnabled = ("function" == typeof f.postMessage || "object" == typeof f.postMessage) && !t.isKonqueror())
                }
            ).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
        }
            , {
                ...
                return {
                    filterToEnabled: function(e, n) {
                        ...
                        return e ? "string" == typeof e && (e = [e]) : e = [],
                            t.forEach(function(t) {
                                t && ("websocket" !== t.transportName || !1 !== n.websocket ? e.length && -1 === e.indexOf(t.transportName) ? o("not in whitelist", t.transportName) : t.enabled(n) ? (o("enabled", t.transportName),
                                    r.main.push(t),
                                t.facadeTransport && r.facade.push(t.facadeTransport)) : o("disabled", t.transportName) : o("disabled from server", "websocket"))
                            }),
                            r
                    }
                }
                    ...
                    (function() {
                            ...
                            function W(t, l) {
                                ...
                                var c = t.Number || D.Number
                                    ...
                                    , r = t.Math || D.Math
                                    , o = t.JSON || D.JSON;
                                "object" == typeof o && o && (l.stringify = o.stringify,
                                    l.parse = o.parse);
                                    ...
                                    if ((j = i.hasOwnProperty) || (j = function(t) {
                                        ...
                                        S = function(t, e) {
                                            ...
                                            for (r in (n = function() {
                                                ...
                                                j.call(s, r) && o++;
                                            return n = s = null,
                                                (S = o ? 2 == o ? function(t, e) {
                                                            var n, r = {}, o = O.call(t) == p;
                                                            for (n in t)
                                                                o && "prototype" == n || j.call(r, n) || !(r[n] = 1) || !j.call(t, n) || e(n)
                                                        }
                                                        : function(t, e) {
                                                            var n, r, o = O.call(t) == p;
                                                            for (n in t)
                                                                o && "prototype" == n || !j.call(t, n) || (r = "constructor" === n) || e(n);
                                                    ...
                                                    : (s = ["valueOf", "toString", "toLocaleString", "propertyIsEnumerable", "isPrototypeOf", "hasOwnProperty", "constructor"],
                                                            function(t, e) {
                                                                var n, r, o = O.call(t) == p, i = !o && "function" != typeof t.constructor && q[typeof t.hasOwnProperty] && t.hasOwnProperty || j;
                                                                for (n in t)
                                                                    o && "prototype" == n || !i.call(t, n) || e(n);
                                        ...
                                        var m = {
                                            ...
                                            if ("object" == typeof a && a)
                                                if ("[object Date]" != (l = O.call(a)) || j.call(a, "toJSON"))
                                                    "function" == typeof a.toJSON && (l != C && l != N && l != A || j.call(a, "toJSON")) && (a = a.toJSON(t));
                                                else if (-1 / 0 < a && a < 1 / 0) {
                                                    if (I) {
                                                        for (f = k(a / 864e5),
                                                                 c = k(f / 365.2425) + 1970 - 1; I(c + 1, 0) <= f; c++)
                                                            ;
                                                        for (u = k((f - I(c, 0)) / 30.42); I(c, u + 1) <= f; u++)
                                                            ;
                                                        f = 1 + f - I(c, u),
                                                            d = k((h = (a % 864e5 + 864e5) % 864e5) / 36e5) % 24,
                                                            p = k(h / 6e4) % 60,
                                                            m = k(h / 1e3) % 60,
                                                            v = h % 1e3
                                                    } else
                                        ...
                                        l.stringify = function(t, e, n) {
                                            ...
                                            if (q[typeof e] && e)
                                                if ((s = O.call(e)) == p)
                                                    ...
                                                    i = {};
                                                    for (var a, l = 0, c = e.length; l < c; a = e[l++],
                                        ...
                                        function b() {
                                            for (var t, e, n, r, o, i = w, s = i.length; g < s; )
                                                switch (o = i.charCodeAt(g)) {
                                                    ...
                                                    case 58:
                                                    case 44:
                                                        return t = a ? i.charAt(g) : i[g],
                                                            g++,
                                                            t;
                                                    case 34:
                                                        for (t = "@",
                                                                 g++; g < s; )
                                                            if ((o = i.charCodeAt(g)) < 32)
                                                                v();
                                                            else if (92 == o)
                                                                switch (o = i.charCodeAt(++g)) {
                                                                    case 92:
                                                                    ...
                                                                    case 117:
                                                                        for (e = ++g,
                                                                                 n = g + 4; g < n; g++)
                                                                            48 <= (o = i.charCodeAt(g)) && o <= 57 || 97 <= o && o <= 102 || 65 <= o && o <= 70 || v();
                                                                        t += x("0x" + i.slice(e, g));
                                                                        break;
                                                                    default:
                                                                        v()
                                                                ...
                                                                if (34 == o)
                                                                    break;
                                                                for (o = i.charCodeAt(g),
                                                                         e = g; 32 <= o && 92 != o && 34 != o; )
                                                                    o = i.charCodeAt(++g);
                                                                t += i.slice(e, g)
                                                            }
                                                        if (34 == i.charCodeAt(g))
                                                            return g++,
                                                                t;
                                                        v();
                                                    default:
                                                        ...
                                                        45 == o && (r = !0,
                                                            o = i.charCodeAt(++g)),
                                                        48 <= o && o <= 57) {
                                                            for (48 == o && (48 <= (o = i.charCodeAt(g + 1)) && o <= 57) && v(),
                                                                     r = !1; g < s && (48 <= (o = i.charCodeAt(g)) && o <= 57); g++)
                                                                ;
                                                            ...
                                                            if (101 == (o = i.charCodeAt(g)) || 69 == o) {
                                                                for (43 != (o = i.charCodeAt(++g)) && 45 != o || g++,
                                                                         n = g; n < s && (48 <= (o = i.charCodeAt(n)) && o <= 57); n++)
                                                                    ;
                                                                n == g && v(),
                                                                    g = n
                                                            }
                                        ...
                                        var g, w, x = u.fromCharCode, _ = {
                                            ...
                                            "string" == typeof t) {
                                                ...
                                                if ("{" == t) {
                                                    for (e = {}; "}" != (t = b()); n = n || !0)
                                                        n && ("," == t ? "}" == (t = b()) && v() : v()),
                                                        "," != t && "string" == typeof t && "@" == (a ? t.charAt(0) : t[0]) && ":" == b() || v(),
                                                            e[t.slice(1)] = U(b());
                                                    return e
                                                }
                                                v()
                                ...
                                return l.runInContext = W,
                                    l
                            }
                            if (!e || e.global !== e && e.window !== e && e.self !== e || (D = e),
                                t)
                                W(D, t);
                            else {
                                var n = D.JSON
        ...
        56: [function(t, e, n) {
            ...
            n.stringify = function(t, e) {
                e = e || "";
                var n = [];
                for (var r in "string" != typeof e && (e = "?"),
                    t)
                        ...
                        for ("object" != u && "string" != u && (n = e,
                            e = null),
                             n && "function" != typeof n && (n = p.parse),
                                 ...
                                 t = o.rest,
                             o.slashes || (c[3] = [/(.*)/, "pathname"]); h < c.length; h++)
                            "function" != typeof (s = c[h]) ? (i = s[0],
                                l = s[1],
                                i != i ? f[l] = t : "string" == typeof i ? ~(a = t.indexOf(i)) && (t = "number" == typeof s[2] ? (f[l] = t.slice(0, a),
                                    t.slice(a + s[2])) : (f[l] = t.slice(a),
                                    t.slice(0, a))) : (a = i.exec(t)) && (f[l] = a[1],
                                    t = t.slice(0, a.index)),
                                f[l] = f[l] || r && s[3] && e[l] || "",
                            s[4] && (f[l] = f[l].toLowerCase())) : t = s(t);
                        n && (f.query = n(f.query)),
                        r && e.slashes && "/" !== f.pathname.charAt(0) && ("" !== f.pathname || "" !== e.pathname) && (f.pathname = function(t, e) {
                    ...
                    y.prototype = {
                        set: function(t, e, n) {
                            ...
                            switch (t) {
                                ...
                                case "port":
                                    r[t] = e,
                                        d(e, r.protocol) ? e && (r.host = r.hostname + ":" + e) : (r.host = r.hostname,
                                            r[t] = "");
                                    break;
                                case "hostname":
                                    r[t] = e,
